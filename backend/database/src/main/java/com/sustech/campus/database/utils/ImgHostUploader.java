 ...
 * 使用UUID重新命名文件，防止冲突
 * 根据日期打散目录：yyyy/mm/dd
 * http://t.csdnimg.cn/zlJCs
 */


@Component
public class ImgHostUploader {

    private static final Logger LOGGER = LoggerFactory.getLogger(ImgHostUploader.class);
    ...
    public String upload (MultipartFile multipartFile) throws IOException {
        ...
        System.out.println("上传完毕: {}" + response);
