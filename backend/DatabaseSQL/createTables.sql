...
values (1, '2023-12-01 08:30:45', '喜欢在第三教学楼学习，环境优雅，设施齐全。', 1, 2.00, 1);

-- Comment 2
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (2, '2023-12-02 12:15:20', '在一丹图书馆度过愉快的阅读时光，氛围很好。', 2, 3.00, 1);
...
-- Comment 4
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (4, '2023-12-04 14:55:30', '理学院的实验设备先进，老师也很热情，学习体验很好。', 4, 2.00, 1);

-- Comment 5
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (5, '2023-12-05 10:10:55', '湖畔食堂的菜品口味独特，价格适中，是我常去的用餐地点。', 5, 1.00, 1);

-- Comment 6
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (1, '2023-12-06 15:50:25', '湖畔宿舍环境舒适，生活设施完备，住得很满意。', 6, 31.00, 1);
...
-- Comment 8
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (3, '2023-12-02 09:05:15', '一丹图书馆的藏书丰富，对于我的专业研究提供了很多参考资料。', 2, 17.00, 1);
...
-- Comment 10
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (5, '2023-12-04 11:45:50', '理学院的学术氛围浓厚，对于科研工作提供了良好的平台。', 4, 64.00, 1);
...
-- Comment 12
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (2, '2023-12-06 12:25:05', '湖畔宿舍的周围环境宜人，生活很方便，是一个理想的居住地。', 6, 14.00, 1);
...
-- Comment 15
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (5, '2023-12-03 17:45:22', '琳恩图书馆的夜景很美，夜间学习的氛围很棒。', 3, 34.00, 1);

-- Comment 16
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (1, '2023-12-04 13:10:50', '理学院的课程设置合理，培养了我很多专业技能。', 4, 15.00, 1);
...
-- Negative Comment 2
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (2, '2023-12-02 14:15:20', '一丹图书馆的空调效果很差，夏天里很难集中注意力。', 2, 203.00, 1);

-- Negative Comment 3
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (3, '2023-12-03 21:45:10', '琳恩图书馆的电脑总是出故障，导致我无法顺利完成作业。', 3, 22.00, 1);

-- Negative Comment 4
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (4, '2023-12-04 17:55:30', '理学院的实验室设备陈旧，需要进行更新和维护。', 4, 103.00, 1);

-- Negative Comment 5
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (5, '2023-12-05 13:10:55', '湖畔食堂的卫生状况堪忧，经常发现不干净的餐具。', 5, 82.00, 1);

-- Negative Comment 6
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (1, '2023-12-06 19:50:25', '湖畔宿舍的楼道噪音太大，严重影响了我的休息时间。', 6, 53.00, 1);
...
-- Mixed Comment 2
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (3, '2023-12-02 12:15:20', '一丹图书馆的空间设计独特，但馆内设备有待提升。', 2, 7.00, 1);

-- Mixed Comment 3
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (4, '2023-12-03 19:45:10', '琳恩图书馆的外观很漂亮，但座位相对较拥挤。', 3, 9.00, 1);
...
-- Mixed Comment 5
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (1, '2023-12-05 10:10:55', '湖畔食堂的菜品种类不够多，但价格相对亲民。', 5, 10.00, 1);

-- Mixed Comment 6
insert into comment(user_ID, time, text, building_ID, score, admin_ID)
values (2, '2023-12-06 15:50:25', '湖畔宿舍的环境宜人，但有时候设施运行不够稳定。', 6, 1.00, 1);
...
INSERT INTO Reservation (room_ID, start_time, end_time, user_ID, description)
VALUES
    (7, '2023-12-01 14:00:00', '2023-12-01 16:00:00', 2, '机器学习讨论'),
    (18, '2023-12-01 17:30:00', '2023-12-01 19:30:00', 4, '前端开发项目会议'),
    (55, '2023-12-02 10:00:00', '2023-12-02 12:00:00', 1, '数据可视化研究'),
    (33, '2023-12-02 15:30:00', '2023-12-02 17:30:00', 5, '网络安全演练'),
    (62, '2023-12-03 09:00:00', '2023-12-03 11:00:00', 3, '人工智能项目评审'),
    (13, '2023-12-03 14:30:00', '2023-12-03 16:30:00', 2, '大数据处理讨论'),
    (27, '2023-12-04 11:00:00', '2023-12-04 13:00:00', 1, '软件工程研讨会'),
    (42, '2023-12-04 15:30:00', '2023-12-04 17:30:00', 4, '数据库优化策略'),
    (14, '2023-12-05 10:30:00', '2023-12-05 12:30:00', 3, '项目管理培训'),
    (68, '2023-12-05 14:00:00', '2023-12-05 16:00:00', 5, '人机交互设计讨论'),
    (39, '2023-12-06 16:30:00', '2023-12-06 18:30:00', 2, '数据挖掘研究小组'),
    (21, '2023-12-06 19:00:00', '2023-12-06 21:00:00', 1, '人才招聘会'),
    (50, '2023-12-07 10:00:00', '2023-12-07 12:00:00', 4, '新技术演示会'),
    (11, '2023-12-07 13:30:00', '2023-12-07 15:30:00', 3, '敏捷开发实践分享'),
    (73, '2023-12-01 09:00:00', '2023-12-01 11:00:00', 5, '云计算解决方案会议'),
    (30, '2023-12-01 12:30:00', '2023-12-01 14:30:00', 2, 'DevOps流程讨论'),
    (58, '2023-12-02 16:00:00', '2023-12-02 18:00:00', 4, '前沿技术趋势研究'),
    (36, '2023-12-02 19:30:00', '2023-12-02 21:30:00', 1, '软件架构设计评审'),
    (65, '2023-12-03 12:00:00', '2023-12-03 14:00:00', 3, '智能物联网项目讨论'),
    (25, '2023-12-03 17:30:00', '2023-12-03 19:30:00', 5, '网络算法实验')

INSERT INTO Reservation (room_ID, start_time, end_time, user_ID, description)
VALUES
    (17, '2023-12-04 14:00:00', '2023-12-04 16:00:00', 2, '深度学习研究'),
    (48, '2023-12-04 17:30:00', '2023-12-04 19:30:00', 4, '项目验收会议'),
    (29, '2023-12-05 10:00:00', '2023-12-05 12:00:00', 1, '用户体验设计讨论'),
    (54, '2023-12-05 15:30:00', '2023-12-05 17:30:00', 5, '网络攻防实战'),
    (11, '2023-12-06 09:00:00', '2023-12-06 11:00:00', 3, 'AI算法优化讨论'),
    (23, '2023-12-06 14:30:00', '2023-12-06 16:30:00', 2, '分布式系统设计'),
    (39, '2023-12-07 11:00:00', '2023-12-07 13:00:00', 1, '软件测试新技术介绍'),
    (63, '2023-12-07 15:30:00', '2023-12-07 17:30:00', 4, '数据库安全策略'),
    (15, '2023-12-01 10:30:00', '2023-12-01 12:30:00', 3, '创业经验分享'),
    (68, '2023-12-01 14:00:00', '2023-12-01 16:00:00', 5, '自然语言处理研究'),
    (31, '2023-12-02 16:30:00', '2023-12-02 18:30:00', 2, '区块链技术应用'),
    (42, '2023-12-02 19:00:00', '2023-12-02 21:00:00', 1, '人才培养计划会议'),
    (56, '2023-12-03 10:00:00', '2023-12-03 12:00:00', 4, '智能交通系统讨论'),
    (24, '2023-12-03 13:30:00', '2023-12-03 15:30:00', 3, '敏捷团队合作培训'),
    (73, '2023-12-04 09:00:00', '2023-12-04 11:00:00', 5, '大数据治理方案'),
    (34, '2023-12-04 12:30:00', '2023-12-04 14:30:00', 2, '企业数字化转型战略'),
    (59, '2023-12-05 16:00:00', '2023-12-05 18:00:00', 4, 'AI在医疗中的应用'),
    (45, '2023-12-05 19:30:00', '2023-12-05 21:30:00', 1, '软件开发效率提升'),
    (67, '2023-12-06 12:00:00', '2023-12-06 14:00:00', 3, '云原生应用架构'),
    (27, '2023-12-06 17:30:00', '2023-12-06 19:30:00', 5, '网络隐私保护技术')

INSERT INTO Reservation (room_ID, start_time, end_time, user_ID, description)
VALUES
    (12, '2023-12-07 10:30:00', '2023-12-07 12:30:00', 2, '创新项目汇报'),
    (36, '2023-12-07 14:00:00', '2023-12-07 16:00:00', 4, '前端框架讨论'),
    (51, '2023-12-01 09:00:00', '2023-12-01 11:00:00', 1, '大数据挖掘实践'),
    (23, '2023-12-01 12:30:00', '2023-12-01 14:30:00', 5, 'DevSecOps培训'),
    (62, '2023-12-02 16:00:00', '2023-12-02 18:00:00', 3, '机器人技术发展'),
    (17, '2023-12-02 19:30:00', '2023-12-02 21:30:00', 2, '软件质量保障策略'),
    (45, '2023-12-03 11:00:00', '2023-12-03 13:00:00', 1, '智能家居技术论坛'),
    (29, '2023-12-03 14:30:00', '2023-12-03 16:30:00', 4, '产品经理沙龙'),
    (57, '2023-12-04 10:00:00', '2023-12-04 12:00:00', 3, '区块链与数字身份'),
    (14, '2023-12-04 15:30:00', '2023-12-04 17:30:00', 5, '网络营销新趋势'),
    (31, '2023-12-05 10:30:00', '2023-12-05 12:30:00', 2, 'AI在农业的应用'),
    (49, '2023-12-05 14:00:00', '2023-12-05 16:00:00', 1, '敏捷方法与Scrum'),
    (64, '2023-12-06 16:30:00', '2023-12-06 18:30:00', 4, '容器化应用部署'),
    (21, '2023-12-06 19:00:00', '2023-12-06 21:00:00', 3, '人才招聘与面试技巧'),
    (42, '2023-12-07 10:00:00', '2023-12-07 12:00:00', 5, '软件架构演进策略'),
    (15, '2023-12-07 13:30:00', '2023-12-07 15:30:00', 1, '智能交通系统讲座'),
    (69, '2023-12-01 09:00:00', '2023-12-01 11:00:00', 3, '敏捷团队培训'),
    (38, '2023-12-01 12:30:00', '2023-12-01 14:30:00', 2, '网络安全漏洞分析'),
    (53, '2023-12-02 16:00:00', '2023-12-02 18:00:00', 1, '数据隐私保护研讨'),
    (28, '2023-12-02 19:30:00', '2023-12-02 21:30:00', 5, '软件开发流程改进')

INSERT INTO Reservation (room_ID, start_time, end_time, user_ID, description)
VALUES
    (19, '2023-12-03 14:00:00', '2023-12-03 16:00:00', 2, '人工智能在医学中的应用'),
    (46, '2023-12-03 17:30:00', '2023-12-03 19:30:00', 4, '软件产品设计讨论'),
    (27, '2023-12-04 10:00:00', '2023-12-04 12:00:00', 1, 'DevOps最佳实践'),
    (54, '2023-12-04 13:30:00', '2023-12-04 15:30:00', 5, '网络安全演练'),
    (13, '2023-12-05 09:00:00', '2023-12-05 11:00:00', 3, '创业者分享会'),
    (33, '2023-12-05 12:30:00', '2023-12-05 14:30:00', 2, '前沿技术趋势展望'),
    (62, '2023-12-06 16:00:00', '2023-12-06 18:00:00', 1, '智能家居安全讨论'),
    (25, '2023-12-06 19:30:00', '2023-12-06 21:30:00', 4, '大数据分析案例分享'),
    (41, '2023-12-07 10:00:00', '2023-12-07 12:00:00', 3, '软件架构演进趋势'),
    (16, '2023-12-07 14:30:00', '2023-12-07 16:30:00', 5, '敏捷开发实践研讨'),
    (72, '2023-12-01 11:00:00', '2023-12-01 13:00:00', 2, '人机交互体验评估'),
    (38, '2023-12-01 14:30:00', '2023-12-01 16:30:00', 1, '网络隐私保护技术'),
    (56, '2023-12-02 10:00:00', '2023-12-02 12:00:00', 4, '机器学习在金融中的应用'),
    (22, '2023-12-02 13:30:00', '2023-12-02 15:30:00', 3, '软件测试自动化策略'),
    (49, '2023-12-03 09:00:00', '2023-12-03 11:00:00', 5, '新兴技术趋势预测'),
    (65, '2023-12-03 12:30:00', '2023-12-03 14:30:00', 2, 'AI在制造业的创新'),
    (31, '2023-12-04 16:00:00', '2023-12-04 18:00:00', 1, '区块链技术发展论坛'),
    (47, '2023-12-04 19:30:00', '2023-12-04 21:30:00', 4, '软件开发流程改进'),
    (14, '2023-12-05 11:00:00', '2023-12-05 13:00:00', 3, '大数据伦理与隐私'),
    (59, '2023-12-05 14:30:00', '2023-12-05 16:30:00', 5, '软件产品交互设计')

INSERT INTO Reservation (room_ID, start_time, end_time, user_ID, description)
VALUES
    (32, '2023-12-06 10:00:00', '2023-12-06 12:00:00', 2, '软件开发新趋势研究'),
    (51, '2023-12-06 13:30:00', '2023-12-06 15:30:00', 4, '数据安全与隐私保护'),
    (18, '2023-12-07 09:00:00', '2023-12-07 11:00:00', 1, '云计算架构设计'),
    (39, '2023-12-07 12:30:00', '2023-12-07 14:30:00', 5, 'DevOps最佳实践'),
    (64, '2023-12-01 16:00:00', '2023-12-01 18:00:00', 3, '智能语音识别技术'),
    (27, '2023-12-01 19:30:00', '2023-12-01 21:30:00', 2, '项目管理经验分享'),
    (45, '2023-12-02 11:00:00', '2023-12-02 13:00:00', 1, '区块链应用案例研究'),
    (18, '2023-12-02 14:30:00', '2023-12-02 16:30:00', 4, '软件架构演进策略'),
    (56, '2023-12-03 10:00:00', '2023-12-03 12:00:00', 3, '机器学习算法讨论'),
    (23, '2023-12-03 13:30:00', '2023-12-03 15:30:00', 5, '网络安全风险评估'),
    (37, '2023-12-04 09:00:00', '2023-12-04 11:00:00', 2, '软件测试自动化工具'),
    (49, '2023-12-04 12:30:00', '2023-12-04 14:30:00', 1, '智能交通管理系统'),
    (60, '2023-12-05 16:00:00', '2023-12-05 18:00:00', 4, '大数据应用案例分享'),
    (28, '2023-12-05 19:30:00', '2023-12-05 21:30:00', 1, '软件产品质量控制'),
    (42, '2023-12-06 12:00:00', '2023-12-06 14:00:00', 3, '人工智能伦理讨论'),
    (16, '2023-12-06 17:30:00', '2023-12-06 19:30:00', 5, '软件开发流程改进'),
    (34, '2023-12-07 10:00:00', '2023-12-07 12:00:00', 2, '区块链在金融领域的应用'),
    (51, '2023-12-07 13:30:00', '2023-12-07 15:30:00', 4, '前端框架性能优化'),
    (19, '2023-12-01 09:00:00', '2023-12-01 11:00:00', 3, '软件产品设计与创新'),
    (48, '2023-12-01 12:30:00', '2023-12-01 14:30:00', 5, '人工智能与医学图像处理')
